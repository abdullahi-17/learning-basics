/* You must find the 🔑 golden key, number 100.

Iterate through the keys array, and if you find the golden key in the array, print “You found the golden key!”. Otherwise, end the program. */
